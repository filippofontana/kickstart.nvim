...
do
  ...
  require('blink.cmp').setup {
    keymap = {
      ...
      preset = 'default',
      -- Set the keybindings I'm used to (instead of Tab and S-Tab) for snippets navigation
...
-- Custom commands that are not related to kickstart-nvim which I personally use
